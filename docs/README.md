...
1. Clone the repository: git clone https://github.com/KOSASIH/starlight-station.git
...
1. Fork the repository: git fork https://github.com/KOSASIH/starlight-station.git
